...
public class MoveCube3 : MonoBehaviour
{
    [SerializeField] private GameObject _cube; // Reference to the existing cube object
    ...
    public URGSensor _urg; // URG sensor
    ...
    void Update()
    {
        ...
        if (objs != null && objs.Length > 0)
        {
            ...
            pp = new Vector3(detectedObject.x, detectedObject.y, detectedObject.z); // Update pp with the position of the detected object
            MoveCubeAtPosition(pp);
            _cube.SetActive(true);

            //Debugging: Log the value of pp
            //Debug.Log($"MoveCube3: Detected object at {pp}");
        ...
        else
        {
            ...
            // Debugging: Log when no object is detected
            //Debug.Log("MoveCube3: No object detected");
        }
